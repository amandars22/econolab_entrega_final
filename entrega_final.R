...
# Site de refer�ncia: https://www.bcb.gov.br/noticiablogbc/27/noticia
...
# INCC (�NDICE NACIONAL DE CUSTO DA CONSTRU��O) -----
...
#Filtrando o per�odo desejado (dados filtrado entre 2000 e 2024)
...
#Adicionando uma nova m�trica ao relat�rio BC (ou fazendo um novo relat�rio)
...
# Adicionando a coluna ano para que seja poss�vel fazer o join
...
# IPS (�NIDICE DE PRE�OS DE SERVI�OS) [FERCOMERCIO-SP] -----

#fonte (https://www.fecomercio.com.br/pesquisas/indice/ips)

# Esse dados come�aram a ser disponibilizados somente a partir de 2011
...
# Os dados de ips come�am a ser medido de 2011 at� 2025 por isso fiz o novo corte
...
#Importando base (excel com os dados) - Per�odo entre 1947 e 2024 
#Dado anual em milh�es de reais
#Fonte: IBGE

pib <- read_excel("pib_industria.xls")  

# Tratamentos iniciais: renomar as colunas e limitar o per�odo ao analisado no estudo
pib <- pib %>% 
...
#Relat�rio incorporando a nova coluna
